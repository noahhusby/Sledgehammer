...
public class ForgeChannel {
    ...
    private final Map<Integer, Class<? extends IForgePacket>> packetMap = new HashMap<>();
    private final Map<Class<? extends IForgePacket>, Integer> discriminatorMap = new HashMap<>();
