...
package com.noahhusby.sledgehammer.server.gui.inventories.warp;

import com.noahhusby.sledgehammer.common.warps.Warp;
import com.noahhusby.sledgehammer.server.Constants;
import com.noahhusby.sledgehammer.server.SledgehammerUtil;
import com.noahhusby.sledgehammer.server.gui.inventories.general.GUIChild;
import com.noahhusby.sledgehammer.server.gui.inventories.general.GUIHelper;
...
public class AllWarpInventory extends GUIChild {
    private final int page;
    private final List<Warp> warps;

    private Inventory inventory;

    public AllWarpInventory(int page, List<Warp> warps) {
        this.page = page;
        this.warps = warps;
    }
    ...
    public void init() {
        ...
        if(((AllWarpInventoryController) getController()).getPayload().isEditAccess())
